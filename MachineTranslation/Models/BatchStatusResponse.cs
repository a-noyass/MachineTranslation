...
namespace Azure.AI.Translator.Models
{
    ...
    public partial class BatchStatusResponse
    {
        ...
        public BatchStatusResponse(IList<BatchesJobState> value = default(IList<BatchesJobState>), string nextLink = default(string))
        {
            Value = value;
            NextLink = nextLink;
            CustomInit();
        ...
        public IList<BatchesJobState> Value { get; set; }
