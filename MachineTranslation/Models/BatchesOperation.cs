...
#pragma warning restore CA1065 // Do not raise exceptions in unexpected locations
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchesOperation"/> class.
        /// </summary>
        /// <param name="operationId">The ID of this operation.</param>
        /// <param name="client">The client used to check for completion.</param>
        public BatchesOperation(string operationId, TranslatorClient client)
        {
        ...
        internal BatchesOperation(TranslatorRestClient serviceClient, ClientDiagnostics diagnostics, string operationLocation)
        {
        ...
        /// An instance of <see cref="BatchesOperation"/> sends requests to a server in UpdateStatusAsync, UpdateStatus, and other methods.
        ...
        private async ValueTask<Response> UpdateStatusAsync(bool async, CancellationToken cancellationToken)
        {
            if (!_hasCompleted)
            {
                using DiagnosticScope scope = _diagnostics.CreateScope($"{nameof(BatchesOperation)}.{nameof(UpdateStatus)}");
                scope.Start();
                ...
                try
                {
                    Response<BatchesJobState> update = async
                        ...
                        : _serviceClient.BatchesStatus(Id, cancellationToken);
                    ...
                    {
                        _requestFailedException = await _diagnostics.CreateRequestFailedExceptionAsync(_response).ConfigureAwait(false);
